...
public class GroupTypeManager implements IGroupTypeManager {
    ...
    @Override
    public GroupType findByGroupTypeName(String name) {
        GroupType gt = null;
        try {
    ...
    @Override
    public void deleteGroupType(GroupType gt) {
        try {
            HibernateUtil.beginTransaction();
    ...
    @Override
    public GroupType findGroupTypeById(int id) {
        GroupType gt = null;
        try {
            HibernateUtil.beginTransaction();
    ...
    @Override
    public void saveGroupType(GroupType gt) {
        try {
            HibernateUtil.beginTransaction();
    ...
    @Override
    public void createGroupType(GroupType gt) {
        try {
            HibernateUtil.beginTransaction();
