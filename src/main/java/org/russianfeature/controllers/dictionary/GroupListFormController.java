...
public class GroupListFormController {
    ...
    private StudentEditFormController editForm;
    ...
    public void setEditForm(StudentEditFormController editForm) {
    ...
    private void setEntityList() {
        dataList = (ObservableList<GroupDOO>) GroupDOOManager.getGroupDOOObservableList();
        ...
        mainTable.setRowFactory( tv -> {
            ...
            row.setOnMouseClicked(event -> {
                if (event.getClickCount() == 2 && (! row.isEmpty()) ) {
                    GroupDOO item = row.getItem();
                    int a = 0;
                    HashMap<String, Integer> eAttr = editForm.getEntitiesAttr();
                    eAttr.put(GroupDOO.class.toString(), ((GroupDOO) item).getId());
...
//                        eAttr.put(typeParameterClass.toString(), ((Teacher) item).getId());
    ...
    private Integer getIndexByEntity(GroupDOO entity) {
