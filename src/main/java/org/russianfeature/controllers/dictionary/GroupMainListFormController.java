...
public class GroupMainListFormController {

    private Main mainApp;
    private ObservableList<GroupDOO> dataList = FXCollections.observableArrayList();
    ...
    @FXML
    private TableView<GroupDOO> mainTable;
    ...
    void btnDeleteOnClick(ActionEvent event) {
        ...
        ObservableList<GroupDOO> selectedEntity = mainTable.getSelectionModel().getSelectedItems();
...
//            List<GroupDOOLoadInfo> entityList = getEntityListFromExcel(file);
//
...
//                } else {
    ...
    private void deleteGroupDOO(ObservableList<GroupDOO> selectedEntity) {
    ...
    private void loadDataInTableView() {
        ...
        if (dataList.size() > 0) {
            if (currentEntity == null) {
                ...
                Integer index = getIndexByGroupDOO(currentEntity);
                if (index >= 0) {
    ...
    private ObservableList<GroupDOO> getGroupDOOList() {
        ...
        for (GroupDOO gt : gtList) {
            gt.setGroupTypeName(gt.getGroupType().getGroupTypeName());
        }
    ...
    private void setFormEvents() {
        mainTable.setRowFactory( tv -> {
            TableRow<GroupDOO> row = new TableRow<>();
    ...
    private void showEditCreateWindow(EnumAction action) {
        ...
        try {
            ...
            loader.setLocation(Main.class.getResource("/fxml/dictionary/GroupEditForm.fxml"));
            ...
            currentEntity = (GroupDOO) controller.getEntity();
