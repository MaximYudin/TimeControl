...
public class GroupTypeEditFormController {

    private Main mainApp;
    private Stage stage;
    private GroupType currentEntity;
    private EnumAction action;
    private ObservableList<GroupType> doublesList = FXCollections.observableArrayList();
    //private Class<T> typeParameterClass;
    private Method method;
    private TableView<GroupType> tableDoubles;
    private List<String> columnList = new ArrayList<>();
    private GroupType entity;
    ...
    public void setEntity(GroupType entity) {
        this.currentEntity = entity;
    }

    public GroupType getEntity() {
    ...
    public void addButtonCheckDoublesEventHandler(Button btnCheckDublicate) {
        btnCheckDublicate.setOnAction(event -> {
            ...
            doublesList = getDoublesGroupTypeList();
...
//            }
 //       });
    ...
    private ObservableList<GroupType> getDoublesGroupTypeList() {
        ...
        List<GroupType> gtList = (List<GroupType>) gtm.getDoubles(params);
    ...
    private void saveGroupTypeEntity() {
        StringBuilder sbMsgText = new StringBuilder();
        if (!isFormFieldsValueValid(sbMsgText)) {
            CommonUtil.showNotificationWindow(mainApp, sbMsgText);
            return;
    ...
    void updateGroupType() {
        ...
        setEntityProperty();
        //GroupTypeManager.save((GroupType) entity);
        GroupTypeManager.save(currentEntity);
    }

    void createGroupType() {
        GroupTypeManager GroupTypeManager = new GroupTypeManager();

        currentEntity = new GroupType();
        setEntityProperty();
        GroupTypeManager.save(currentEntity);
    }
