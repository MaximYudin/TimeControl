...
public class PositionEditFormController {

    private Main mainApp;
    private Stage stage;
    private Position currentEntity;
    private EnumAction action;
    private ObservableList<Position> doublesList = FXCollections.observableArrayList();
    //private Class<T> typeParameterClass;
    private Method method;
    private TableView<Position> tableDoubles;
    ...
    public void addButtonCheckDoublesEventHandler(Button btnCheckDublicate) {
        btnCheckDublicate.setOnAction(event -> {
            ...
            doublesList = getDoublesPositionList();
    ...
    private void drawTableView(VBox vbox) {
        ...
        for (Field fld : Position.class.getDeclaredFields()) {
            ...
            if (fld.getType().equals(IntegerProperty.class)) {
                TableColumn<Position, Integer> myColumn = new TableColumn<>(CommonUtil.getMapFieldName(fieldName));
                myColumn.setCellValueFactory(new PropertyValueFactory<Position, Integer>(fieldName));
...
//    private ObservableList<Position> getDoublesPositionList() {
//
//
...
//        List<Position> stList = (List<Position>) PositionManager.getDoubles(params);
//
//        for (Position Position : stList) {
...
//        PositionManager PositionManager = new PositionManager();
//        ObservableList<Position> PositionList = FXCollections.observableArrayList();
//        List<Position> tList = (List<Position>) PositionManager.getDoubles(params);
//
//        for (Position Position : tList) {
//            PositionList.add(Position);
//        }
//
//        return PositionList;
...
//
    private ObservableList<Position> getDoublesPositionList() {
        ...
        List<Position> gtList = (List<Position>) gtm.getDoubles(params);
...
//    }
    ...
    private void savePositionEntity() {
        StringBuilder sbMsgText = new StringBuilder();
        if (!isFormFieldsValueValid(sbMsgText)) {
            CommonUtil.showNotificationWindow(mainApp, sbMsgText);
            return;
...
//        PositionManager PositionManager = new PositionManager();
//        setEntityProperty();
//        //PositionManager.save((Position) entity);
//        PositionManager.save(currentEntity);
//    }
...
//        PositionManager PositionManager = new PositionManager();
//
//        currentEntity = (Position) new Position();
//        setEntityProperty();
//        PositionManager.save(currentEntity);
//    }
