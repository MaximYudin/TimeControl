...
public class RegimeEditFormController {

    private Main mainApp;
    private Stage stage;
    private Regime currentEntity;
    private EnumAction action;
    private ObservableList<Regime> doublesList = FXCollections.observableArrayList();
    //private Class<T> typeParameterClass;
    private Method method;
    private TableView<Regime> tableDoubles;
    ...
    public void setEntity(Regime entity) {
        this.currentEntity = entity;
    }

    public Regime getEntity() {
    ...
    public void addButtonCheckDoublesEventHandler(Button btnCheckDublicate) {
        btnCheckDublicate.setOnAction(event -> {
            ...
            doublesList = getDoublesRegimeList();
    ...
    private void drawTableView(VBox vbox) {
        ...
        for (Field fld : Regime.class.getDeclaredFields()) {
            ...
            if (fld.getType().equals(IntegerProperty.class)) {
                TableColumn<Regime, Integer> myColumn = new TableColumn<>(CommonUtil.getMapFieldName(fieldName));
                myColumn.setCellValueFactory(new PropertyValueFactory<Regime, Integer>(fieldName));
...
//            }
 //       });
    ...
    private ObservableList<Regime> getDoublesRegimeList() {
        ...
        List<Regime> gtList = gtm.getDoubles(params);
    ...
    void createRegime() {
        ...
        currentEntity = new Regime();
        setEntityProperty();
        RegimeManager.save(currentEntity);
    }
