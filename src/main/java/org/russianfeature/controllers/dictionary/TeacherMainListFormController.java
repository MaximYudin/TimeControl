...
public class TeacherMainListFormController {

    private Main mainApp;
    private ObservableList<Teacher> dataList = FXCollections.observableArrayList();
    ...
    @FXML
    private TableColumn<Teacher, String> col1;
    ...
    void btnDeleteOnClick(ActionEvent event) {
        ...
        ObservableList<Teacher> selectedEntity = mainTable.getSelectionModel().getSelectedItems();
...
//            return;
        ...
        if (file != null) {
            ...
            List<TeacherLoadInfo> entityList = getEntityListFromExcel(file);
...
//    }
    ...
    private void deleteTeachers(ObservableList<Teacher> selectedEntity) {
    ...
    private void loadDataInTableView() {
        ...
        if (dataList.size() > 0) {
            if (currentEntity == null) {
                ...
                Integer index = getIndexByTeacher(currentEntity);
                if (index >= 0) {
...
//
//        TeacherManager TeacherManager = new TeacherManager();
//        List<Teacher> stList = TeacherManager.getAll();
//        ObservableList<Teacher> TeacherList = FXCollections.observableArrayList(stList);
//
//        for (Teacher Teacher : stList) {
//            Teacher.setGroupName4Visual(Teacher.getGroupDOO().getGroupName());
//        }
//
//        return TeacherList;
//    }
    ...
    private ObservableList<Teacher> getTeacherList() {
        ...
        ObservableList<Teacher> teacherList = FXCollections.observableArrayList(tList);
        /*
...
//    }
    ...
    void setColumnProperty() {
        ...
        if (createDate != null) {
            ...
            createDate.setCellFactory(column -> {
                TableCell<Teacher, String> cell = new TableCell<>() {
    ...
    private void showEditCreateWindow(EnumAction action) {
        ...
        try {
            ...
            Stage TeacherDialogAction = new Stage();
            TeacherDialogAction.setTitle("Создание/редактирование");

            FXMLLoader loader = new FXMLLoader();
            loader.setLocation(Main.class.getResource("/fxml/dictionary/TeacherEditForm.fxml"));

            AnchorPane TeacherAction = loader.load();

            TeacherAction.setId("dictionaryFormAction");

            // Bind controller and main app
            TeacherEditFormController controller = loader.getController();
            controller.setMainApp(mainApp);
            controller.setStage(TeacherDialogAction);
            ...
            TeacherDialogAction.setScene(new Scene(TeacherAction));
            TeacherDialogAction.initOwner(mainApp.getPrimaryStage());
            TeacherDialogAction.initModality(Modality.APPLICATION_MODAL);
            TeacherDialogAction.showAndWait();

            currentEntity = (Teacher) controller.getEntity();
    ...
    private void showPreloadForm(List<TeacherLoadInfo> stList) {
        ...
        try {
            ...
            controller.setTypeParameterClass(TeacherLoadInfo.class);
            ...
            //currentTeacher = controller.getTeacher();
...
//    }
    ...
    private List<TeacherLoadInfo> getEntityListFromExcel(File file) {
        List<TeacherLoadInfo> entityList = new ArrayList<>();
        try {
            entityList = (List<TeacherLoadInfo>) ExcelReader.getTeacherListFromExcel(file);
//            if (typeParameterClass.equals(Teacher.class))
