...
public class _DictionaryMainListFormController<T> {
...
//            student.setGroupName(student.getGroupDOO().getGroupName());
//        }
    ...
    private void showEditCreateWindow(EnumAction action) {
        ...
        try {
            ...
            loader.setLocation(Main.class.getResource("/fxml/dictionary/_DictionaryEditForm.fxml"));
            ...
            _DictionaryEditFormController controller = loader.getController();
